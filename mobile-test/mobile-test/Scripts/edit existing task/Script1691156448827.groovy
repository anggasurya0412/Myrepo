...
Mobile.clearText(findTestObject('Object Repository/Task name field'), 0)

Mobile.setText(findTestObject('Object Repository/Task name field'), newText, 0)

Mobile.tap(findTestObject('Object Repository/save button'), 0)

def newTitle = Mobile.getText(findTestObject('Object Repository/title'), 0)
Mobile.verifyEqual(newTitle,newText)
